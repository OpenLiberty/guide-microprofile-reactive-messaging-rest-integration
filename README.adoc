...
= Trigger messages in reactive Java microservices via RESTful endpoints
...
to make requests using a graphical interface. To make a request with Postman, enter `\http://localhost:9085/inventory/systems/property`
