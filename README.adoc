...
The changes include creating the [hotspot=flowableEmitter file=0]`propertyNameEmitter` variable, and the
[hotspot=updateSystemProperty file=0]`updateSystemProperty()` and [hotspot=sendProperty file=0]`sendPropertyName()` methods.
