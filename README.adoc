...
== Creating the REST endpoint to produce messages
...
== Creating the property message processor
...
message serializer and deserializers. To complete the message loop created in the previous sections, four more channels
